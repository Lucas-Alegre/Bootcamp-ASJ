...
--12 - Mostrar el top 3 de artistas con el promedio de duraci�n de las canciones, en orden descendente con la canci�n mas 
--larga primero
...
SELECT ar.nombre FROM artista ar
JOIN album al ON al.artista_id = ar.id
